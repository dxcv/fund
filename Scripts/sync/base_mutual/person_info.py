...
def transform():
    ...
    df_020001 = df.ix[df[PersonInfo.data_source.name] == "020001"]
    ...
    df_020002 = df.ix[df[PersonInfo.data_source.name] == "020002"]
    df_020003 = df.ix[df[PersonInfo.data_source.name] == "020003"]
