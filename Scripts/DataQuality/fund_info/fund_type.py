...
def main():
    ...
    ftm_stra = ftm.loc[ftm["typestandard_code"] == 1, ["fund_id", "type_name", "stype_name"]]
    ftm_stra["fund_type_strategy"] = ftm_stra["type_name"] + "_" + ftm_stra["stype_name"]
    ftm_stra = ftm_stra[["fund_id", "fund_type_strategy"]]

    ftm_issu = ftm.loc[ftm["typestandard_code"] == 3, ["fund_id", "type_name", "stype_name"]]
    ftm_issu = ftm_issu[["fund_id", "type_name"]]
    ftm_issu.columns = ["fund_id", "fund_type_issuance"]

    ftm_stru = ftm.loc[ftm["typestandard_code"] == 4, ["fund_id", "type_name", "stype_name"]]
